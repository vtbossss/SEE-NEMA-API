"""
Django settings for SEENEMA_API project.
...
ALLOWED_HOSTS = ['seenema.pythonanywhere.com','127.0.0.1','localhost']
...
WSGI_APPLICATION = "SEENEMA_API.wsgi.application"
